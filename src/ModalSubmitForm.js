...
class ModalSubmitForm extends Component{
    ...
    constructor(props){
        ...
        this.state = {
            ...
            calcReport: this.props.calcReport,
            formState: 'form',
            response: '',
            iep: this.props.iep
    ...
    showForm(){
        ...
        console.log("score: "+this.state.mathPlacement);
    }
            ...
            return(
                <div className="pt-4">
                    <div className={submitCardClass}>
                        <div className="card-body">
                            <h2>Submit My Placements</h2>
                            <p>You must submit your results to acknowledge your placements and receive clearance to register for English and Math courses.</p>
